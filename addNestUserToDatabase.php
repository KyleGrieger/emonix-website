...
$sql = "INSERT INTO users (email,nest_access_token,nest_access_token_expiry,thermostat_id,postalcode,timezone) VALUES ('$email','$nest_access_token','$nest_access_token_expiry','$thermostat_id','$postalcode','$timezone')";
